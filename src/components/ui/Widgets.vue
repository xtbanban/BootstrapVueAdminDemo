    ...
    <div class="wrapper-md">
              ...
              <div class="panel b-a">
                ...
                <div class="text-center m-b clearfix">
                  <div class="thumb-lg avatar m-t-n-xxl">
                    <img src="../../assets/app/img/a5.jpg" alt="..." class="b b-3x b-white">
              ...
              <div class="panel no-border">
                <div class="panel-heading bg-primary lt">
                  ...
                  <div class="text-center m-t-md">
                    <div>loading...</div>
                    <div class="sparkline inline m-t m-b-n-sm"></div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="panel panel-info">
                ...
                <img src="../../assets/app/img/a4.jpg" alt="...">
              ...
              <div class="panel panel-default">
                ...
                <ul class="list-group no-radius">
                  <li class="list-group-item">
                    ...
                    <span class="label bg-primary">1</span> .inc company
                  </li>
                  <li class="list-group-item">
                    <span class="pull-right">23,200</span>
                    <span class="label bg-info">2</span> Gamecorp
                  </li>
                  <li class="list-group-item">
                    <span class="pull-right">21,000</span>
                    <span class="label bg-warning">3</span> Starup
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="panel-body">
              <div class="clearfix text-center m-t">
                <div class="inline">
                  <div>
                    <div class="thumb-xl">
                      <img src="../../assets/app/img/a8.jpg" class="img-circle" alt="...">
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="m-b">
                <a href class="pull-left thumb-sm avatar"><img src="../../assets/app/img/a2.jpg" alt="..."></a>
                <div class="m-l-xxl">
              ...
              <div class="m-b">
                <a href class="pull-right thumb-sm avatar"><img src="../../assets/app/img/a3.jpg" class="img-circle" alt="..."></a>
                <div class="m-r-xxl">
                  <div class="pos-rlt wrapper bg-primary r r-2x">
                    <span class="arrow right pull-up arrow-primary"></span>
                    <p class="m-b-none">Lorem ipsum dolor sit amet, conse
                      <br>adipiscing eli...
                      <br>:)</p>
                  </div>
            ...
            <footer class="panel-footer">
              <!-- chat form -->
              <div>
                <a class="pull-left thumb-xs avatar"><img src="../../assets/app/img/a3.jpg" class="img-circle" alt="..."></a>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body" ui-jq="slimScroll" ui-options="{height:'250px', size:'8px'}">
              <div class="media">
                <span class="pull-left thumb-sm"><img src="../../assets/app/img/a2.jpg" alt="..."></span>
        ...
        <div class="col-lg-6">
          ...
          <div class="m-b b-l m-l-md streamline">
            ...
            <img src="../../assets/app/img/a1.jpg" class="img-circle" alt="...">
          </a>
            ...
            <img src="../../assets/app/img/a8.jpg" alt="...">
          </a>
              <div class="m-l-xxl panel b-a">
                ...
                10m ago
                  ...
                  <a href>Mika Sam</a> Report this comment is helpful
                </div>
              </div>
            </div>
            <!-- / .comment-reply -->
            <div>
              <a class="pull-left thumb-sm avatar m-l-n-md">
            <img src="../../assets/app/img/a9.jpg" alt="...">
          </a>
              <div class="m-l-lg panel b-a">
                <div class="panel-heading pos-rlt b-b b-light">
                  <span class="arrow left"></span>
            ...
            <div>
              <a class="pull-left thumb-sm avatar m-l-n-md"><img src="../../assets/app/img/a5.jpg" alt="..."></a>
              <div class="m-l-lg panel b-a">
                <div class="panel-heading pos-rlt b-b b-light">
                  <span class="arrow left"></span>
                  <a href>Peter</a>
          ...
          <div class="clearfix m-b-lg">
            <a class="pull-left thumb-sm avatar"><img src="../../assets/app/img/a6.jpg" alt="..."></a>
            <div class="m-l-xxl">
              <form class="m-b-none">
                <div class="input-group">
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <img src="../../assets/app/img/a7.jpg" alt="...">
          ...
          <i class="away b-white"></i>
            ...
            <a href class="avatar thumb-xs m-r-xs">
          <img src="../../assets/app/img/a10.jpg" alt="...">
          <i class="on b-white"></i>
        </a>
        ...
        <div class="col-sm-6">
          <div class="panel b-a">
            ...
            <ul class="list-group list-group-lg no-bg auto">
              ...
              <li class="list-group-item clearfix">
                <span class="pull-left thumb-sm avatar m-r">
              <img src="../../assets/app/img/a5.jpg" alt="...">
              <i class="on b-white bottom"></i>
            </span>
                <span class="clear">
              ...
              <li class="list-group-item clearfix">
                <span class="pull-left thumb-sm avatar m-r">
              <img src="../../assets/app/img/a6.jpg" alt="...">
