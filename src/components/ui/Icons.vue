  ...
  <div>
    ...
    <div class="wrapper-md">
      ...
      <div class="row list-icon">
        ...
        <div class="col-md-3 col-sm-4">
          <i class="icon-moustache"></i> icon-moustache
        </div>
        <div class="col-md-3 col-sm-4">
        ...
        <div class="col-md-3 col-sm-4">
          <i class="icon-eyeglasses"></i> icon-eyeglasses
        </div>
        <div class="col-md-3 col-sm-4">
          <i class="icon-envelope-open"></i> icon-envelope-open
        </div>
        <div class="col-md-3 col-sm-4">
          <i class="icon-envelope-letter"></i> icon-envelope-letter
        </div>
        <div class="col-md-3 col-sm-4">
          <i class="icon-energy"></i> icon-energy
        </div>
        <div class="col-md-3 col-sm-4">
          <i class="icon-emoticon-smile"></i> icon-emoticon-smile
        </div>
        <div class="col-md-3 col-sm-4">
        ...
        <div class="col-md-3 col-sm-4">
          <i class="icon-camcorder"></i> icon-camcorder
        </div>
        <div class="col-md-3 col-sm-4">
