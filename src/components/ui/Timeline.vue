  ...
  <div class="hbox hbox-auto-xs hbox-auto-sm">
    ...
    <div class="col w-lg bg-light dk b-r bg-auto" id="aside">
      <div class="wrapper bg b-b">
        <button class="btn btn-sm btn-success pull-right">Center</button>
      ...
      <div class="wrapper">
        <form>
          ...
          <div class="m-t-md m-b-md">
            <button class="btn btn-sm btn-primary" type="button">Add an event</button>
          </div>
        </form>
      </div>
    </div>
            ...
            <div class="tl-wrap b-primary">
              ...
              <div class="tl-content panel padder b-a w-md w-auto-xs">
                ...
                <div class="panel-body pull-in b-t b-light">
                  <a class="thumb pull-right m-l m-t-xs avatar">
                  <img src="../../assets/app/img/a4.jpg" alt="...">
                  <i class="on md b-white bottom"></i>
                </a>
                  <div class="clear">
                    <a class="text-primary block m-b-xs">@Mike Mcalidek <i class="icon-twitter"></i></a>
                    <a class="btn btn-addon btn-sm btn-primary m-t-xs"><i class="fa fa-eye"></i> Follow</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="tl-wrap b-primary">
              ...
              <div class="tl-content panel padder b-a block">
                ...
                <div class="panel-body pull-in b-t b-light">
                  ...
                  <div class="m-b m-t">
                    <a class="avatar thumb-xs m-r-xs">
                    ...
                    <a class="btn btn-success btn-rounded font-bold"> +152 </a>
                  ...
                  <div class="panel panel-default m-t-md m-b-n-sm pos-rlt">
                    ...
                    <div class="panel-footer bg-light lter">
                      ...
                      <ul class="nav nav-pills nav-sm">
                        <li><a><i class="fa fa-camera text-muted"></i></a></li>
                        <li><a><i class="fa fa-video-camera text-muted"></i></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
